...
public class CrystalZombie extends Monster implements MultiBehaviourUser {
    protected static final EntityDataAccessor<Integer> BEHAVIOUR_STATE = SynchedEntityData.defineId(CrystalZombie.class, EntityDataSerializers.INT);
    protected static final EntityDataAccessor<Integer> BEHAVIOUR_TICKS = SynchedEntityData.defineId(CrystalZombie.class, EntityDataSerializers.INT);
    private static final int MELEE_ID = 1;
    public final AnimationState idleAnimationState = new AnimationState();
    public final AnimationState meleeAnimationState = new AnimationState();
    private final BehaviourManager<CrystalZombie> behaviourManager = new BehaviourManager<>(this, List.of(
            new MeleeAttackPhase<CrystalZombie>(MELEE_ID, 1, 30, 30).with(2, 12)
    ));

    public CrystalZombie(EntityType<CrystalZombie> type, Level world) {
        super(type, world);
        setMaxUpStep(0.6f);
        xpReward = 0;
